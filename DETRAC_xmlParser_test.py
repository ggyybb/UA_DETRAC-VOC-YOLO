                ...
                if (target.tag == "target"):
                    ...
                    for target_child in target:
                        if (target_child.tag == "box"):
                            ...
                            xmin_value = float(target_child.attrib["left"])
                            ymin_value = float(target_child.attrib["top"])
                            box_width_value = float(target_child.attrib["width"])
                            box_height_value = float(target_child.attrib["height"])
                        ...
                        if (target_child.tag == "attribute"):
                            ...
                            name.appendChild(doc.createTextNode(name_value))
...
if (__name__ == "__main__"):
    ...
    #ConvertVOCXml(file_path="samplexml",file_name="DETRAC-Train-Annotations-XML/MVI_20012.xml")
    # Start time
    start = time.time()
